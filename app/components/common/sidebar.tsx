  ...
  return (
    <div className="w-full border-medium px-4 py-4 rounded-small border-default-400 dark:border-default-100">
      ...
      <div className="flex w-full max-w-full items-center justify-between rounded-lg py-1 px-3 text-zinc-950 dark:text-zinc-400">
        ...
        <Link className="mr-auto text-large font-semibold text-zinc-950 dark:text-zinc-400 p-4" href={home()}>{t("Dashboard")}</Link>
      </div>
      }
      ...
      <div className="flex w-full max-w-full items-center justify-between rounded-lg py-1 px-3 text-zinc-950 dark:text-zinc-400">
        ...
        <Link className="mr-auto text-large font-semibold text-zinc-950 dark:text-zinc-400 p-4" href={adminCompanies()}>Companies</Link>
      </div>
      }
      ...
      <div className="flex w-full max-w-full items-center justify-between rounded-lg py-1 px-3 text-zinc-950 dark:text-zinc-400">
        ...
        <Link className="mr-auto text-large font-semibold text-zinc-950 dark:text-zinc-400 p-4" href={invoices()}>Invoices</Link>
      </div>
      }
      ...
      <div className="flex w-full max-w-full items-center justify-between rounded-lg py-1 px-3 text-zinc-950 dark:text-zinc-400">
        ...
        <Link className="mr-auto text-large font-semibold text-zinc-950 dark:text-zinc-400 p-4" href={packages()}>Packages</Link>
      </div>
      }
      ...
      <div className="flex w-full max-w-full items-center justify-between rounded-lg py-1 px-3 text-zinc-950 dark:text-zinc-400">
        ...
        <Link className="mr-auto text-large font-semibold text-zinc-950 dark:text-zinc-400 p-4" href={newEntry()}>New Entry</Link>
      </div>
      }
